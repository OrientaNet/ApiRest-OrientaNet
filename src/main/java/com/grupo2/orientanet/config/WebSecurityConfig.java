...
import com.grupo2.orientanet.security.JWTAuthenticationEntryPoint;
import com.grupo2.orientanet.security.JWTConfigurer;
import com.grupo2.orientanet.security.JWTFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher("/pruebas")).permitAll()
                                .requestMatchers(antMatcher("/preguntas")).permitAll()
