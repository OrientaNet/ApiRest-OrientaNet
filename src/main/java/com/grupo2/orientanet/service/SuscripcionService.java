...
public interface SuscripcionService {
    ...
    SuscripcionDTO suscribirEstudianteAPlan(Long estudianteId, Long planId, Double monto, MetodoPago metodoPago);
...
//    List<Pago> getPagosBySuscripcion(Long suscripcionId);
}
